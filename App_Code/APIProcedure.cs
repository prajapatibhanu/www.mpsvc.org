   ...
   at System.Data.SqlClient.SqlCommand.ExecuteNonQuery()", "").Replace("Error Msg :", "<b style='color:Red;'>Error Msg :</b>").Replace("Event Info :", "<b style='color:Red;'>Event Info :</b>");
    ...
    public void SendMailMPSVC(String UserId, String Subject, String Body, String filepath, string mobileNumber, string message)
    {
        try
        {
            ...
            //string authKey = "m22P25e3z0200zV7doXm9B";
            ...
            //string link = "http://sms.mssinfotech.in/api/mt/SendSMS?APIKey=" + authKey + "&senderid=" + senderId + "&channel=trans&DCS=0&flashsms=0&number=" + mobileNumber + "&text=" + Message + "&route=8";
            //Comment Date 12Mar2020 //string link = "http://mysms.mssinfotech.com/app/smsapi/index.php?key=3597C1493C124F&routeid=318&type=text&contacts=" + mobileNumber + "&senderid=MPSVCI&msg=" + Message;
			 
			 
			// string link = "http://mysms.mssinfotech.com/app/smsapi/index.php?key=3597C1493C124F&routeid=2&type=text&contacts=" + mobileNumber + "&senderid=MPSVCI&msg=" + Message;
			 
			//string link = "http://mysms.mssinfotech.com/app/smsapi/index.php?key=3597C1493C124F&routeid=310&type=text&contacts=" + mobileNumber + "&senderid=MPSVCI&msg=" + Message;
			
			 string link = "http://loginsms.ewyde.com/rest/services/sendSMS/sendGroupSms?AUTH_KEY=a29938b6e184b2d6256f595c77a7ba&message=" + Message + "&senderId=MPSVCB&routeId=8&mobileNos=" + mobileNumber + "&smsContentType=english";
        ...
        //    //EmailServiceFromSFA.EmailMPSVC MS = new EmailServiceFromSFA.EmailMPSVC();
        ...
        //    WebMail.UserName = "mpsvcveterinary@gmail.com";
        //    WebMail.Password = "@BHOPALVETY_123";
        ...
        string subjectLine = Subject;
        string msg = Body;
        string fileAttachment = System.AppDomain.CurrentDomain.BaseDirectory + "/" + filepath;
        //string with = "with";
        string errorMessage = "";
        try
        {
            ...
            mail.From = new MailAddress("mpsvcveterinary@gmail.com");
            mail.To.Add(customerEmail);
            mail.Bcc.Add("ankuramchur@gmail.com");
            ...
            //SmtpServer.Port = 587;
            SmtpServer.Credentials = new System.Net.NetworkCredential("mpsvcveterinary@gmail.com", "@BHOPALVETY_123");
    ...
    public string CreateMessageBody(int i, string applicationno)
    {
        ...
        if (i == 0)
        {
            sbNew.Append("Your new registration request sent successfully. your application no " + applicationno + " MPSVC Bhopal.");
        }
        if (i == 1)
        {
            sbNew.Append("Your renew registration request sent successfully. your registration no " + applicationno + " MPSVC Bhopal.");
        }
        if (i == 2)
        {
            sbNew.Append("Your transfer registration request sent successfully. your registration no " + applicationno + " MPSVC Bhopal");
        }
        if (i == 3)
        {
            sbNew.Append("Your Transfer in MP registration request sent successfully. your application no " + applicationno + " MPSVC Bhopal.");
        }
        if (i == 4)
        {
            sbNew.Append("Your Duplicate ID Card Request sent successfully. your application no " + applicationno + " MPSVC Bhopal.");
        }
        if (i == 5)
        {
            sbNew.Append("Your Duplicate Certificate Registration request sent successfully. your application no " + applicationno + " MPSVC Bhopal");
        }
        if (i == 6)
        {
            sbNew.Append("Your update qualification registration request sent successfully. your application no " + applicationno + " MPSVC Bhopal.");
        }
        if (i == 7)
        {
            sbNew.Append("Your provisional registration request sent successfully. your application no " + applicationno + " MPSVC Bhopal.");
        }
    ...
    public string CreateAdminMessageBody(int i, string registrationNo)
    {
        ...
        if (i == 0)
        {
            sbVerified.Append("Your new registration is verified successfully. your registration no.. : " + registrationNo + " MPSVC Bhopal");
        }
        if (i == 1)
        {
            sbVerified.Append("Your renew registration is verified successfully. your registration no " + registrationNo + " MPSVC Bhopal.");
        }
        if (i == 2)
        {
            sbVerified.Append("Your transfer registration is verified successfully. your registration no " + registrationNo + " MPSVC Bhopal.");
        }
        if (i == 3)
        {
            sbVerified.Append("Your Transfer in MP registration is verified successfully. your registration no " + registrationNo + " MPSVC Bhopal");
        }
        if (i == 4)
        {
            sbVerified.Append("Your duplicate Id Card registration is verified successfully. your registration no. : " + registrationNo + " MPSVC Bhopal");
        }
        if (i == 5)
        {
            sbVerified.Append(". Your duplicate certificate registration is verified successfully. your registration no. : " + registrationNo + " MPSVC Bhopal");
        }
        if (i == 6)
        {
            sbVerified.Append("Your update qualification registration is verified successfully. your registration no. : " + registrationNo + " MPSVC Bhopal");
        }
        if (i == 7)
        {
            sbVerified.Append("Your provisional registration is verified successfully. your registration no. : " + registrationNo + " MPSVC Bhopal.");
        }
    ...
    public string Send_OTP(string mobNo)
    {
		...
		Msg = "Your OTP is " + str + " Please don't share with anyone...MPSVC Bhopal";
    ...
    public void sendOTPSms(string mobileNumber, string message)
    {
        try
        {
			 if (mobileNumber != "")
            {
                ...
                DataSet ds12 = ByProcedure("sp_sms", new string[] { "flag", "MobileNo", "msg" }, new string[] { "1", mobileNumber, message }, "BYdataset");
                if (ds12.Tables[0].Rows.Count > 0)
                {
					 if (ds12.Tables[0].Rows[0]["Status"].ToString() == "true")
                    {
            //// Vias Group Credential Start
            //// For Sending SMS
            ////Your authentication key
            //string authKey = "97368Amvyj8EFL563df93f";
            ////Multiple mobiles numbers separated by comma
            ...
            //string link = "http://sms.mssinfotech.in/api/mt/SendSMS?APIKey=" + authKey + "&senderid=" + senderId + "&channel=trans&DCS=0&flashsms=0&number=" + mobileNumber + "&text=" + Message + "&route=8";
           // string link = "http://mysms.mssinfotech.com/app/smsapi/index.php?key=3597C1493C124F&routeid=288&type=text&contacts=" + mobileNumber + "&senderid=MPSVCI&msg=" + message;
			// string link = "http://mysms.mssinfotech.com/app/smsapi/index.php?key=3597C1493C124F&routeid=2&type=text&contacts=" + mobileNumber + "&senderid=MPSVCI&msg=" + message;
