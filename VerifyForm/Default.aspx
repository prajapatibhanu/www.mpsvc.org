<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="VerifyForm_Default" %>
...
<div class="NonPrintable" id="Divprint" runat="server">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <table border="1" runat="server" id="tbdld" >
                        <tr>
                            <td><b> S.No.</b></td>
     ...
     <asp:Button ID="btnprint"  Text="Print" CssClass="btn btn-primary" runat="server" OnClick="btnprint_Click" Value="Generate PDF" />
</form>
