<%@ Page Language="C#" MasterPageFile="~/AdminSection/AdminMaster.master" AutoEventWireup="true"
    CodeFile="CollegeMaster.aspx.cs" Inherits="AdminSection_CollegeMaster" Title="Untitled Page" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table width="100%">
        <tr>
            <td style="text-align: left" colspan="3">
                <strong>Collage &nbsp;Master</strong>
            </td>
        </tr>
        <tr>
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Sr.No">
                            <ItemTemplate>
                                ...
                                <asp:HiddenField ID="HiddenField2" runat="server" Value='<%# Eval("UniversityID") %>'>
                                </asp:HiddenField>
                            </ItemTemplate>
                        </asp:TemplateField>
