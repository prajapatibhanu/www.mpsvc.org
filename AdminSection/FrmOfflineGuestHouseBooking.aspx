<%@ Page Title="" Language="C#" MasterPageFile="~/AdminSection/GuestHouseMaster.master" AutoEventWireup="true" CodeFile="FrmOfflineGuestHouseBooking.aspx.cs" Inherits="AdminSection_FrmOfflineGuestHouseBooking" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script type="text/javascript" language="javascript">
        function ValidationOnSave() {
            ...
            if (document.getElementById('<%=txtTransactionRefNo.ClientID%>').value.trim() == "") {
                msg = msg + "- Please enter transaction ref no. \n";
            }
            if (msg != '') {
                alert(msg);
                return false;
        ...
        function days_between(date1, date2) {
            ...
            <table width="100%" align="center">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <cc1:CalendarExtender ID="CalendarExtender1" runat="server" PopupButtonID="imgFromdt" TargetControlID="txtFromdt"
                            Format="dd/MM/yyyy">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlPayment" runat="server">
                        ...
                        <asp:ListItem Text="Card machine" Value="1"></asp:ListItem>
                    </asp:DropDownList>
                    <span style="color: Red">*</span>
                </td>
                <td>Transaction Ref No </td>
                <td>
                    <asp:TextBox ID="txtTransactionRefNo" MaxLength="20" runat="server"></asp:TextBox>
                    <span style="color: Red">*</span>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="4" align="center">
                    <asp:Button ID="btnBook" runat="server" CssClass="btn" OnClick="btnBook_Click" Text="Proceed For Booking" OnClientClick="return ValidationOnSave();" />
                </td>
            </tr>
            </table>
