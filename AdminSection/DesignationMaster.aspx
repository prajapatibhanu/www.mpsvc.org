<%@ Page Language="C#" MasterPageFile="~/AdminSection/AdminMaster.master" AutoEventWireup="true"
    CodeFile="DesignationMaster.aspx.cs" Inherits="AdminSection_DesignationMaster"
    Title="Untitled Page" %>
    ...
    <table width="100%">
        ...
        <tr>
            ...
            <td colspan="2" style="text-align: left">
                <asp:DropDownList ID="DropDownList1" runat="server" CssClass="txtbox reqirerd" AutoPostBack="True"
        ...
        <tr>
            ...
            <td colspan="2" style="text-align: left">
                <asp:DropDownList ID="DropDownList2" runat="server" CssClass="txtbox reqirerd">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="3" style="text-align: left">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Designation  Name" DataField="DesinationName" />
