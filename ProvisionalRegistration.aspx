<%@ Page Title="" Language="C#" MasterPageFile="~/AdminSection/MasterPage.master" AutoEventWireup="true" EnableEventValidation="false" EnableViewStateMac="false" CodeFile="ProvisionalRegistration.aspx.cs" Inherits="ProvisionalRegistration" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function ValidationInitialization() {
			...
			if (document.getElementById('<%=ddlResDistrict.ClientID%>').value == "Select") {
                msg = msg + "-Please select residential district \n";
            }
			...
			else if (document.getElementById('<%=ddlPerDistrict.ClientID%>').value == "Select") {
                msg = msg + "-Please select permanent district \n";
            }
            ...
            if (document.getElementById('<%=FileUpload1.ClientID%>').value.trim() == "") {
                msg = msg + "-University certificate can not be left blank \n";
            }
            if (document.getElementById('<%=FileUpload2.ClientID%>').value.trim() == "") {
                msg = msg + "-Photo  can not be left blank \n";
            }
    ...
    <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td colspan="4">
                <h2><strong>
                    <asp:Label ID="lblHeader" runat="server" Font-Bold="True" Text="Provisional Registration" ForeColor="Green" Font-Size="15pt"></asp:Label>
                </strong></h2>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>1. &nbsp;<asp:TextBox ID="txtMobileNo1" runat="server" MaxLength="10" Style="width: 65px; font-size: 10px;" CssClass="txtbox reqirerd"
                onblur="return ValidateMobNumber(this)" onkeypress='javascript:tbx_fnInteger(event, this);'></asp:TextBox><span style="color: Red">*</span>
                &nbsp;&nbsp;&nbsp;
                2. &nbsp;
                <asp:TextBox ID="txtMobileNo2" runat="server" MaxLength="10" Style="width: 65px; font-size: 10px;" CssClass="txtbox reqirerd"
                    onblur="return ValidateMobNumber(this)" onkeypress='javascript:tbx_fnInteger(event, this);'></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>Email Id :
                ...
                <table border="1" cellpadding="0" cellspacing="0" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td style="width: 100px; height: 35px;">
                            <asp:DropDownList ID="ddl1" runat="server" Enabled="false" OnSelectedIndexChanged="ddl1_SelectedIndexChanged">
                            </asp:DropDownList><span style="color: Red">*</span>
                        </td>
                        <td style="width: 100px; height: 35px;">
        ...
        <tr>
            ...
            <td>
                <asp:FileUpload ID="FileUpload2" runat="server" onChange="UploadControlValidationForLenthAndFileFormat(100, 'JPEG*PNG*JPG*GIF', this),ValidateFileSize(this)" /><span style="color: Red">*</span>
            </td>
        </tr>
        <tr>
            <td>Others :
            ...
            <td>
                <asp:FileUpload ID="FileUpload3" runat="server" onChange="UploadControlValidationForLenthAndFileFormat(100, 'PDF', this),ValidateFileSize(this)" />
            </td>
        </tr>
        <tr>
            <td>Payment Type :
