...
public partial class FrmRequestGuestHouse : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string ApplicationType = ItemValue[0] + "*" + ItemValue[5];
        ...
        String response = objRequestURL.SendRequest("T", "L47613", MerchantRefNo, "NA", Amount, "INR", UniqueCustId, "http://www.mpsvc.org/FrmResponseGuestHouse.aspx?Type=" + ApplicationType, "NA", "NA", ShopingCardDetail, TransactionDate, EmailId, MobileNo, "470", CustomerName, Server.MapPath("Merchant.property"));
